...
(
  ...
  function createUI(thisObj) {
    ...
    dialog.spacing = 10;
    dialog.margins = 12;
    dialog.preferredSize.height = 9999;
    ...
    var divider5 = tab1.add("panel", undefined, undefined, {
      name: "divider5",
    });
    divider5.alignment = "fill";

    var appearFromBottomButton = tab1.add("button", undefined, undefined, {
      name: "appearFromBottomButton",
    });
    appearFromBottomButton.text = "Appear From Bottom";
    appearFromBottomButton.onClick = appearFromBottom;

    var appearFromTopButton = tab1.add("button", undefined, undefined, {
      name: "appearFromTopButton",
    });
    appearFromTopButton.text = "Appear From Top";
    appearFromTopButton.onClick = appearFromTop;
